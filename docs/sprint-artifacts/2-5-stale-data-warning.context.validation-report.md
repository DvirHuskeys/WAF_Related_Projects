# Validation Report
**Document:** docs/sprint-artifacts/2-5-stale-data-warning.context.xml
...
Evidence: Metadata.story contains <asA>As a persona or GTM user</asA> plus complementary fields.

✓ PASS Acceptance criteria list matches story draft exactly (no invention)
Evidence: AcceptanceCriteria captures sentences such as "Given a domain row whose `last_observed` is older than the freshness SLA (30 days), when the Streamlit UI renders the Radar table or persona cards, then a warning badge (“Data 37d old – re-run enrichment”) appears inline.".
