# Validation Report
**Document:** docs/sprint-artifacts/3-2-score-to-story-mapping.context.xml
...
Evidence: AcceptanceCriteria captures sentences such as "Given scoring thresholds are defined (e.g., drift >0.7), when persona service builds a prompt it uses the matching hook text (“Lead with configuration coherence”) from a central configuration file.".
