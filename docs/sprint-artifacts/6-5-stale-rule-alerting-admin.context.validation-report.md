# Validation Report
**Document:** docs/sprint-artifacts/6-5-stale-rule-alerting-admin.context.xml
...
Evidence: AcceptanceCriteria captures sentences such as "Admin tab displays a table listing domains/rules whose freshness exceeds the SLA, showing type (domain/rule), identifier, last updated, and recommended command.".
